...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2021 at 02:37 PM
...
(9, 'ST-PR0004', 'Iure dolorem dolores', 400, 'Hours', 819, 327600),
(10, 'ST-PR0004', 'Aperiam sunt ea quia', 70, 'Hours', 663, 46410),
(11, 'ST-PR0004', 'Quis sint aliquip si', 6, 'Hours', 520, 3120),
(12, 'ST-PR0004', 'coba 2', 20, 'Hours', 1200, 24000),
...
CREATE TABLE `purchase_order` (
  ...
  `resource_Status` enum('Project Manager','Top Management','Finance','Admin','Sales','Team','Individu') NOT NULL,
...
INSERT INTO `purchase_order` (`no_Po`, `nama_Pm`, `email_pm`, `resource_Name`, `resource_Email`, `resource_Status`, `mobile_Phone`, `date`, `project_Name`, `id_quotation`, `public_Notes`, `regards`, `footer`, `rate`, `address_Resource`, `grand_Total`, `tipe`) VALUES
('ST-PR0003', 'ben zos', 'bneks@gmail.com', 'ada', 'dsadsa', 'Individu', 'coba project', '2021-06-12', 'Est cum consectetur', 'ST-Q0007', 'asdasd', 'sdas', 'dsdas', 0, 'dasdas', 24970600, 'item'),
('ST-PR0004', 'gisin@m', 'ciwyruqu@mailinator.com', 'Soluta incididunt ve', 'Shaeleigh Martin', 'Project Manager', 'Totam molestiae', '2010-11-17', 'Consectetur veniam ', 'ST-Q0009', 'Fugiat commodi Nam ', 'Eligendi aut mollit ', 'Rerum eius velit al', 0, 'Fuga Incididunt dis', 401130, 'item'),
('ST-PR0005', 'nydyrax', 'kiviw@mailinator.com', 'Provident totam sed', 'Reuben Steele', 'Finance', 'Eveniet volupta', '1995-10-18', 'Consectetur veniam ', 'ST-Q0009', 'Qui sit cum tempori', 'Et nihil sit sequi d', 'Cupidatat ex nemo of', 0, 'Quia aliquid archite', 377130, 'item'),
('ST-PR0006', 'difomef', 'rore@mailinator.com', 'Distinctio Amet nu', 'Iola Beck', 'Individu', 'Sequi laborum a', '1996-04-06', 'Eu duis voluptatibus', 'ST-Q0008', 'Pariatur Est qui a', 'Quo magna Nam ut ut ', 'Aut tenetur ipsam au', 0, 'Quo ducimus totam e', 444429, 'item');
...
('STR002', 'irfan', 'coba11', 'muhammad irfan', 'muhammadirfan.9f@gmail.com', 5, 2, 'STR002.jpg', '2021-06-14 12:26:50', '2021-05-19 17:12:39', 0),
('STR003', 'benben', 'bento', 'ben zoskan', 'bneks@gmail.com', 1, 2, 'STR003.jpg', '2021-06-14 12:27:13', '2021-06-10 09:42:27', 0);
...
--
ALTER TABLE `quitation_item`
  MODIFY `id_q_num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
COMMIT;
