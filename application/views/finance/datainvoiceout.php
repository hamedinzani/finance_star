...
<div class="container-fluid">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        ...
        <a>&ensp;&emsp;</a>
        <a href="<?php echo base_url('finance/invoiceout'); ?>"><button type="button" class="btn btn-danger"><i class="fas fa-plus-square" aria-hidden="true"></i> New Invoice</button></a>
