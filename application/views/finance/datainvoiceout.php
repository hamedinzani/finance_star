...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Invoice Out</h1>
    </div>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        ...
        <a href="<?php echo base_url('finance/print'); ?>"><button type="button" class="btn btn-success"><i class="fa fa-print" aria-hidden="true"></i> Print</button></a>
        <a>&emsp;&emsp;</a>
        <a href="<?php echo base_url('finance/invoiceout'); ?>"><button type="button" class="btn btn-danger"> New Invoice </button></a>
    </div>
    <!-- /.container-fluid -->
    <div class="col-lg-12">
            ...
            <table class="table table-borderd table-hover table-striped" id="datatables">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>@mdo</td>
                        <td>
                            <a href="<?php echo base_url('finance/editinvoiceout'); ?>"><button type="button" class="btn" style="color:blue"><i class="fa fa-edit" aria-hidden="true"></i></button></a>
