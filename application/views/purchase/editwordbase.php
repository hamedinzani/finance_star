...
<div class="col-lg-8" style="margin-left:auto;margin-right:auto">
    <div>
        <table class="table table-bordered shadow-lg">
            ...
            <tbody>
                <tr>
                    <td><input type="text" style="width:180px;" id="mw" name="mw" value=""></td>
                    <td><input type="text" style="width:120px;" id="wc" name="wc" value=""></td>
                    <td><input type="text" style="width:150px;" id="w" name="w" value=""></td>
                    <td><input type="text" style="width:230px;" id="wwc" name="wwc" value=""></td>
